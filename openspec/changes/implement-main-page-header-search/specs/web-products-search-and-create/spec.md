...
The products screen SHALL expose its primary product search input in the dedicated main-page header, SHALL execute product search against DummyJSON API, and SHALL render the returned results in the same products table view.
