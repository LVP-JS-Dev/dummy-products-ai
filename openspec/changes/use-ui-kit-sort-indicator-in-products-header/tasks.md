...
- [x] 2.1 Run targeted `apps/web` checks (typecheck + focused tests).
- [x] 2.2 Verify in browser that indicator renders for asc/desc and error/loading states are unaffected.
