# ui-kit-events Specification

## Purpose

Define the event contract model for interactive UI Kit components, including how events and payload schemas are represented in generated artifacts and validated against component states.
...
### Requirement: Events specification SHALL support optional payload schemas

Events MAY define a payload schema. If a payload schema is defined, it SHALL be generated and referenced from the manifest.
